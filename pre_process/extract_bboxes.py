...
import sys
sys.path.append("/root/userfolder/hf2vad/datasets")
...
from mmdet_utils import init_detector, inference_detector
...
#     mm_det_ckpt_file = 'assets/cascade_mask_rcnn_r101_fpn_mstrain_3x_coco_20210628_165236-51a2d363.pth'
...
if __name__ == '__main__':
    ...
    parser.add_argument("--proj_root", type=str, default="/root/userfolder/hf2vad", help='project root path')
